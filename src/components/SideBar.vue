  ...
  <v-row class="">
   <v-col cols="12" lg="12" class="d-flex flex-column align-center align-self-start">
    ...
    <v-list class="nav-links">
     <v-list-item
      ><RouterLink to="/"><homePageLogo class="img-icon" /> Página inicial</RouterLink></v-list-item
     >
     <v-list-item
      ><RouterLink to="/explore"><HashTag class="img-icon" /> Explorar</RouterLink></v-list-item
     >
     <v-list-item
      ><RouterLink to="/profile"><ProfileLogo class="img-icon" /> Perfil</RouterLink></v-list-item
     >
    </v-list>

    <ButtonTweet class="w-50" />
   </v-col>
